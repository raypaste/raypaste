...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "text-foreground flex h-[calc(--spacing(6))] w-fit items-center justify-center gap-2 rounded-sm bg-neutral-200 px-1.5 text-xs font-medium whitespace-nowrap has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0 dark:bg-neutral-800",
        className,
      )}
      {...props}
    >
